...
MOA comes with a search syntax by with you can modify the categories,
...
MOA supports the external bangs from [DuckDuckGo].  To directly jump to a
...
engine, MOA cannot protect your privacy on this.
